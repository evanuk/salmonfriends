...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "SalmonFriendsGame"
        ...
        self.license = "Salmonfriends License"
 
        #Auhor of program
        self.author_name = "Sam Evanuk"
        self.author_email = "samevanuk@gmail.com"
        self.copyright = "Copyright (c) 2014 Me."
 
        #Description
        self.project_description = "SalmonFriends Description"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["coin.py", "enemy.py", "player.py", "assets"]
 
        #Extra/excludes python modules
        self.extra_modules = ["random"]
